...
var ListController = exports.ListController = function (_Component) {
    ...
    function ListController(props) {
        ...
        var enabledSources = props.initiallyEnabledSources.reduce(function (sources, src) {
            return (0, _extends10.default)({}, sources, (0, _defineProperty3.default)({}, src, true));
        }, {});
    ...
    (0, _createClass3.default)(ListController, [{
        ...
        value: function componentWillReceiveProps(nextProps, nextState) {
            if (nextProps.resource !== this.props.resource || !(0, _isEqual2.default)(nextProps.query, this.props.query)) {
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
            if (nextProps.translate === this.props.translate && nextProps.isLoading === this.props.isLoading && nextProps.version === this.props.version && nextState === this.state && nextProps.data === this.props.data && nextProps.selectedIds === this.props.selectedIds && (0, _isEqual2.default)(nextProps.query, this.props.query)) {
                return false;
            }
            return true;
        }
        ...
        value: function getQuery() {
            var query = Object.keys(this.props.query).length > 0 ? this.props.query : (0, _extends10.default)({}, this.props.params);
            if (!query.sort) {
        ...
        value: function updateLocation(params) {
            var query = (0, _extends10.default)({}, (0, _queryString.parse)(this.props.location.search), (0, _defineProperty3.default)({}, this.props.resource, JSON.stringify(params)));

            this.props.push((0, _extends10.default)({}, this.props.location, {
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.showFilter = function (filterName, defaultValue) {
        _this2.setState({
            activeFilters: (0, _extends10.default)({}, _this2.state.activeFilters, (0, _defineProperty3.default)({}, filterName, true))
        });
        if (typeof defaultValue !== 'undefined') {
            _this2.setFilters((0, _extends10.default)({}, _this2.props.filterValues, (0, _defineProperty3.default)({}, filterName, defaultValue)));
        }
    };
    ...
    this.showInactiveFilters = function () {
        var activeFilters = (0, _extends10.default)({}, _this2.state.enabledSources);
        var enabledSources = (0, _extends10.default)({}, _this2.state.enabledSources);
    ...
    this.hideFilter = function (filterName) {
        _this2.setState({
            activeFilters: (0, _extends10.default)({}, _this2.state.activeFilters, (0, _defineProperty3.default)({}, filterName, false))
        });
    ...
    this.setSourceActive = function (source, active) {
        _this2.setState({
            activeFilters: (0, _extends10.default)({}, _this2.state.activeFilters, (0, _defineProperty3.default)({}, source, active)),
            enabledSources: (0, _extends10.default)({}, _this2.state.enabledSources, (0, _defineProperty3.default)({}, source, active))
        });
...
function mapStateToProps(state, props) {
    ...
    var params = (0, _extends10.default)({}, resourceState.list.params, {
