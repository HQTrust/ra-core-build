...
var ListController = exports.ListController = function (_Component) {
    ...
    function ListController(props) {
        ...
        _this.showFilter = function (filterName, defaultValue) {
            _this.setState({
                activeFilters: (0, _extends9.default)({}, _this.state.activeFilters, (0, _defineProperty3.default)({}, filterName, true))
            });
            if (typeof defaultValue !== 'undefined') {
                _this.setFilters((0, _extends9.default)({}, _this.props.filterValues, (0, _defineProperty3.default)({}, filterName, defaultValue)));
            }
        };

        _this.hideActiveFilters = function () {
            _this.setState({ activeFilters: {} });
        };

        _this.showInactiveFilters = function () {
            _this.setState({ activeFilters: _this.state.enabledSources });
        };

        _this.hideFilter = function (filterName) {
            _this.setState({
                activeFilters: (0, _extends9.default)({}, _this.state.activeFilters, (0, _defineProperty3.default)({}, filterName, false))
            });
        ...
        _this.setSourceActive = function (source, active) {
            _this.setState({
                activeFilters: (0, _extends9.default)({}, _this.state.activeFilters, (0, _defineProperty3.default)({}, source, active)),
                enabledSources: (0, _extends9.default)({}, _this.state.enabledSources, (0, _defineProperty3.default)({}, source, active))
            });

            if (!active) {
                _this.setFilters((0, _removeKey2.default)(_this.props.filterValues, source));
            }
        };
