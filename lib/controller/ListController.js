    ...
    (0, _createClass3.default)(ListController, [{
        ...
        value: function updateLocation(params) {
            this.props.push((0, _extends9.default)({}, this.props.location, {
                search: '?' + (0, _queryString.stringify)((0, _extends9.default)({}, params, {
        ...
        value: function render() {
            var _props3 = this.props,
                ...
                hasCreate = _props3.hasCreate,
                data = _props3.data,
                ids = _props3.ids,
                total = _props3.total,
                totalAll = _props3.totalAll,
                isExportable = _props3.isExportable,
                isLoading = _props3.isLoading,
                translate = _props3.translate,
                version = _props3.version,
                selectedIds = _props3.selectedIds,
                metaSources = _props3.metaSources;
...
function mapStateToProps(state, props) {
    ...
    var params = (0, _extends9.default)({}, resourceState.list.params, {
