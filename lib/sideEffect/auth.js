...
exports.default = function (authProvider) {
    ...
    function handleAuth(action) {
        var type, payload, error, meta, authPayload, redirectTo, _redirectTo;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.t0 = type;
                        _context.next = _context.t0 === _authActions.USER_LOGIN ? 4 : _context.t0 === _authActions.USER_CHECK ? 26 : _context.t0 === _authActions.USER_LOGOUT ? 38 : _context.t0 === _fetchActions.FETCH_ERROR ? 43 : 61;
                        break;
                    ...
                    case 46:
                        ...
                        _context.next = 50;
                        return (0, _effects.put)((0, _reactRouterRedux.push)(_redirectTo));
                    ...
                    case 56:
                        _context.next = 58;
                        return (0, _effects.put)((0, _authActions.userLogout)());
