        ...
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    ...
                    _context.next = 3;
                    return (0, _effects.put)((0, _reactRouterRedux.push)((0, _resolveRedirectTo2.default)(redirectTo, basePath, (0, _get2.default)(payload, 'id') || (0, _get2.default)(payload, 'data.id'))));
