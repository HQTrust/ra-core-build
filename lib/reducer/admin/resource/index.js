...
exports.getReferenceResource = exports.getResources = exports.metaMatchesResource = undefined;
...
var metaMatchesResource = exports.metaMatchesResource = function metaMatchesResource(meta, resource) {
    return (0, _get2.default)(meta, 'resource[1].name', (0, _get2.default)(meta, 'resource')) === resource;
};
...
exports.default = function () {
    ...
    var newState = resources.reduce(function (acc, resource) {
        return (0, _extends6.default)({}, acc, (0, _defineProperty3.default)({}, resource, metaMatchesResource(action.meta, resource) ? {
