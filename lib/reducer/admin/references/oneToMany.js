...
exports.parseNameRelatedTo = exports.nameRelatedTo = exports.getReferencesByIds = exports.getReferences = exports.getIds = undefined;
...
var parseNameRelatedTo = exports.parseNameRelatedTo = function parseNameRelatedTo(relatedTo) {
    var resourceAndRest = relatedTo.split(/_(.*)/, 2);
    var resource = resourceAndRest[0];
    var referenceAndRest = resourceAndRest[1].split(/@(.*)/, 2);
    var reference = referenceAndRest[0];
    var targetAndRest = referenceAndRest[1].split(/_(.*)/, 2);
    var target = targetAndRest[0];
    var idAndFilter = targetAndRest[1].split(/\?(.*)/, 2);
    var id = idAndFilter[0];
    var filter = (0, _queryString.parse)(idAndFilter[1]);

    console.log("parseNameRelatedTo9");
