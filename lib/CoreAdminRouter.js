    ...
    (0, _createClass3.default)(CoreAdminRouter, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                unauthenticatedLayout = _props.unauthenticatedLayout,
                    ...
                    customRoutes.filter(function (route) {
                        ...
                        return _react2.default.createElement(_reactRouterDom.Route, {
                            ...
                            render: function render(props) {
                                return (0, _react.createElement)(unauthenticatedLayout, {
                                    children: _this4.renderCustomRoutesWithoutLayout(route, props)
                                });
                            }
                        });
                    }),
...
exports.default = (0, _compose2.default)((0, _getContext2.default)({
    authProvider: _propTypes2.default.func
}), (0, _reactRedux.connect)(mapStateToProps, { init: _actions.init, userLogout: _authActions.userLogout }))(CoreAdminRouter);